...
export default {
  data() {
    return {
      remoteDbEntity: new RemoteDbEntity('forecast'),
      kind: 'query',
      filter: "",
      mode: "list",
      queryData: {
      ...
      uploadFields: [{name: 'serviceName', value: 'forecast'}, {name: 'methodName', value: 'Insert'}],
      columns: [
        ...
        {name: 'predict_finance', label: '预测类型', field: 'predict_finance', sortable: true},
        {name: 'predict_type', label: '预测类型', field: 'predict_type', sortable: true},
        {name: 'increase_avg', align: 'right', label: '预测增长', field: 'increase_avg'},
        {name: 'forecast_avg', align: 'right', label: '预测值', field: 'forecast_avg'},
      ]
    }
  },
  computed: {
