...
import qboot_Bootvueclipboard2 from 'boot/vueclipboard2'

import qboot_Bootlytab from 'boot/ly-tab'
...
async function start () {
  ...
  const bootFiles = [qboot_Booti18n,qboot_Bootvuelidate,qboot_Bootvueclipboard2,qboot_Bootlytab]
