...
export default {
  data() {
    return {
      remoteDbEntity: new RemoteDbEntity('wmqyline'),
      kind: 'query',
      filter: "",
      mode: "list",
      queryData: {
      ...
      uploadFields: [{name: 'serviceName', value: 'wmqyline'}, {name: 'methodName', value: 'Insert'}],
      columns: [
        ...
        {name: 'qdate', label: '季度', field: 'qdate', sortable: true},
